package com.example.smartpi.utils;
...
public final class DrawableUtils {
    ...
    public static Drawable getCircleDrawableWithText(Context context, String string) {
        Drawable background = ContextCompat.getDrawable(context, R.drawable.round_blue);
  ...
  /*  public static Drawable getThreeDots(Context context){
    ...
    public static Drawable getCircleDrawable(Context context) {
        Drawable background = ContextCompat.getDrawable(context, R.drawable.round_blue);
