...
class JadwalKelasAdapter(
    private var data: List<JadwalItem>,
    private val listener: (JadwalItem) -> Unit
) : RecyclerView.Adapter<JadwalKelasAdapter.LeagueViewHolder>() {
    lateinit var contextAdapter: Context

    class LeagueViewHolder(view: View) : RecyclerView.ViewHolder(view) {

        val tvTanggalJadwal = view.findViewById<TextView>(R.id.tv_tgl_jadwal)
        val tvKelas = view.findViewById<TextView>(R.id.tv_kelas)
        val tvJamKelas = view.findViewById<TextView>(R.id.tv_jam_kelas)
        val tvGuru = view.findViewById<TextView>(R.id.tv_guru)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LeagueViewHolder {
        ...
        return JadwalKelasAdapter.LeagueViewHolder(inflatedView)
